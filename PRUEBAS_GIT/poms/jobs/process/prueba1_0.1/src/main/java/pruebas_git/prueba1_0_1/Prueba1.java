	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Prueba1.class.getClassLoader()
					.getResourceAsStream("pruebas_git/prueba1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 43644 characters generated by Talend Cloud Big Data on the 5 de diciembre de
 * 2019 13:54:12 CET
 ************************************************************************************************/