...
package pruebas_git.prueba1_0_1;
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_WukHQBddEeqQo8SlaQ9gOg", "0.1");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PRUEBAS_GIT_Prueba1 = new byte[0];
    static byte[] commonByteArray_PRUEBAS_GIT_Prueba1 = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PRUEBAS_GIT_Prueba1) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Prueba1.class.getClassLoader().getResourceAsStream("pruebas_git/prueba1_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
<<<<<<< HEAD
 *     on the 5 de diciembre de 2019 16:05:47 CET
=======
 *     on the 5 de diciembre de 2019 16:06:06 CET
