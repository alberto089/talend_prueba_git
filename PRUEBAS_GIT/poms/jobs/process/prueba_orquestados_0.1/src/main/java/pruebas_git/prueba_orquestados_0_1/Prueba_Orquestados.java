...
package pruebas_git.prueba_orquestados_0_1;
...
/**
 * Job: Prueba_Orquestados Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Prueba_Orquestados implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Prueba_Orquestados.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(Prueba_Orquestados.class);
	...
	private final String jobName = "Prueba_Orquestados";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_B9tM0BdwEeqYBZCILLG6Gg", "0.1");
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Prueba_Orquestados.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Prueba_Orquestados.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pruebas_git.prueba1_0_1.Prueba1 childJob_tRunJob_1 = new pruebas_git.prueba1_0_1.Prueba1();
				// pass DataSources
				...
				log.info(
						"tRunJob_1 - The child job 'pruebas_git.prueba1_0_1.Prueba1' starts on the version '0.1' with the context 'Default'.");

				String[][] childReturn_tRunJob_1 = childJob_tRunJob_1
						.runJob((String[]) paraList_tRunJob_1.toArray(new String[paraList_tRunJob_1.size()]));

				log.info("tRunJob_1 - The child job 'pruebas_git.prueba1_0_1.Prueba1' is done.");
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tRunJob_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tRunJob_3.append("PROCESS" + " = " + "Prueba2");
							log4jParamters_tRunJob_3.append(" | ");
				...
				pruebas_git.prueba2_0_1.Prueba2 childJob_tRunJob_3 = new pruebas_git.prueba2_0_1.Prueba2();
				// pass DataSources
				...
				log.info(
						"tRunJob_3 - The child job 'pruebas_git.prueba2_0_1.Prueba2' starts on the version '0.1' with the context 'Default'.");
				...
				log.info("tRunJob_3 - The child job 'pruebas_git.prueba2_0_1.Prueba2' is done.");
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tRunJob_4 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tRunJob_4.append("PROCESS" + " = " + "Prueba4");
							log4jParamters_tRunJob_4.append(" | ");
				...
				pruebas_git.prueba4_0_1.Prueba4 childJob_tRunJob_4 = new pruebas_git.prueba4_0_1.Prueba4();
				// pass DataSources
				...
				log.info(
						"tRunJob_4 - The child job 'pruebas_git.prueba4_0_1.Prueba4' starts on the version '0.1' with the context 'Default'.");
				...
				log.info("tRunJob_4 - The child job 'pruebas_git.prueba4_0_1.Prueba4' is done.");
	...
	public static void main(String[] args) {
		final Prueba_Orquestados Prueba_OrquestadosClass = new Prueba_Orquestados();

		int exitCode = Prueba_OrquestadosClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Prueba_Orquestados' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Prueba_Orquestados' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Prueba_Orquestados.class.getClassLoader()
					.getResourceAsStream("pruebas_git/prueba_orquestados_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Prueba_Orquestados.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Prueba_Orquestados");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 58015 characters generated by Talend Cloud Big Data on the 5 de diciembre de
 * 2019 16:05:48 CET
 ************************************************************************************************/